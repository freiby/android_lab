...
public class WelcomeView extends View {
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		final TypedArray a = getContext().obtainStyledAttributes(attrs,
				R.styleable.WelcomeView, defStyle, 0);

		mExampleString = a.getString(R.styleable.WelcomeView_exampleString);
		mExampleColor = a.getColor(R.styleable.WelcomeView_exampleColor,
				mExampleColor);
		// Use getDimensionPixelSize or getDimensionPixelOffset when dealing
		// with
		// values that should fall on pixel boundaries.
		mExampleDimension = a.getDimension(
				R.styleable.WelcomeView_exampleDimension, mExampleDimension);

		if (a.hasValue(R.styleable.WelcomeView_exampleDrawable)) {
			mExampleDrawable = a
					.getDrawable(R.styleable.WelcomeView_exampleDrawable);
